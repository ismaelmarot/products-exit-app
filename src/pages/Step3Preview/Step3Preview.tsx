...
const Step3Preview: React.FC<Step3PreviewProps> = ({ onBack, onNext }) => {
    ...
    return (
        <div>
            ...
            <Row className='mb-3'>
                <Col md={6}><strong>Motivo:</strong> {generalData.reason}</Col>
                <Col md={6}><strong>Responsable:</strong> {generalData.personInCharge}</Col>
                <Col md={6}><strong>Salida:</strong> {generalData.departureDate}</Col>
                <Col md={6}><strong>Regreso:</strong> {generalData.returnDate || '-'}</Col>
            </Row>
