...
//                         <div className='col-3 text-truncate'>{p.description}</div>
//                         <div className='col-2'>{p.producer}</div>
//                         <div className='col-'>{p.category}</div>
//                         <div className='col-2'>{p.code}</div>
//                         <div className='col-1 text-end'>{p.quantity}</div>
